...
Source Database       : b5thinkphp6cmf
...
) ENGINE=InnoDB AUTO_INCREMENT=10009 DEFAULT CHARSET=utf8mb4 COMMENT='管理员表';
...
INSERT INTO `b5net_config` VALUES ('2', '系统名称', 'sys_config_sysname', 'text', '1', 'site', 'B5ThinkCMF', '', '系统后台显示的名称', '2020-12-31 14:01:18', '2022-03-21 16:28:31');
...
) ENGINE=InnoDB AUTO_INCREMENT=10704 DEFAULT CHARSET=utf8mb4 COMMENT='菜单权限表';
...
INSERT INTO `b5net_role` VALUES ('3', '测试角色', 'test', '8', '0', '1', '2022-03-19 23:43:03', '2022-03-19 23:43:16', '');
