...
class DataScopeHelper
{
     ...
     * @throws \Exception
     */
    public static function queryDataScope(BaseQuery $query, string $structField = 'struct_id', string $userField = 'user_id', string $structAlias = '', string $userAlias = ''): object
    {
    ...
    {
        $user_id = LoginAuthHelper::adminLoginInfo('info.id');
